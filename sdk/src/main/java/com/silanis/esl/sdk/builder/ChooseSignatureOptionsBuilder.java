...
public class ChooseSignatureOptionsBuilder {
    ...
    private String defaultSignatureType = ChooseSignatureStyleType.STYLE.name();
    ...
    public ChooseSignatureOptionsBuilder withDefaultSignatureType( ChooseSignatureStyleType chooseSignatureStyleType) {
        this.defaultSignatureType = chooseSignatureStyleType.name();
        return this;
    }
    ...
    public ChooseSignatureOptions build() {
        ...
        result.setDefaultSignatureType(ChooseSignatureStyleType.valueOf(defaultSignatureType));
