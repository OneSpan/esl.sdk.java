...
public class SignatureImageExample extends SDKSample {
    ...
    public void execute() {
        ...
        eslClient.getSignatureImageService().getSignatureImageForSender(senderUID);
        eslClient.getSignatureImageService().getSignatureImageForPackageRole(packageId, signer1.getId());
    }
}
