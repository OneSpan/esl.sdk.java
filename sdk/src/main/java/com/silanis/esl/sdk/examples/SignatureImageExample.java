...
public class SignatureImageExample extends SDKSample {
    ...
    public void execute() {
        ...
        eslClient.getSignatureImageService().getSignatureImageForSender(senderUID, SignatureImageFormat.PNG);
        eslClient.getSignatureImageService().getSignatureImageForPackageRole(packageId, signer1.getId(), SignatureImageFormat.PNG);
    }
}
