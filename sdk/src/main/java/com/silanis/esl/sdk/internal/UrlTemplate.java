...
public class UrlTemplate {
    ...
    public static final String PACKAGE_LIST_STATUS_DATE_RANGE_PATH = "/packages?predefined={status}&from={from}&to={to}&lastUpdatedStartDate={lastUpdatedStartDate}&lastUpdatedEndDate={lastUpdatedEndDate}";
