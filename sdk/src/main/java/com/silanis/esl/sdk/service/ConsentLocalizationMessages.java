...
public final class ConsentLocalizationMessages {
    ...
    public static final String DEFAULT_DOCUMENT_CONSENT_ACCEPTED = "Default document consent modification is not allowed: the transaction has at least one signer who has accepted the default consent.";
