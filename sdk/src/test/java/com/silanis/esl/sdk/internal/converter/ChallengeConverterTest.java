...
public class ChallengeConverterTest implements ConverterTest {
    ...
    public void convertNullSDKToAPI() {
        ...
        assertThat("Converter didn't return a null api object for a null sdk object", converter.toAPIChallenge(), is(nullValue()));
    }
    ...
    public void convertNullAPIToSDK() {
        ...
        assertThat("Converter didn't return a null sdk object for a null api object", converter.toSDKChallenge(), is(nullValue()));
    }
    ...
    public void convertNullSDKToSDK() {
        sdkChallenge = null;
        converter = new ChallengeConverter(sdkChallenge);
        assertThat("Converter didn't return a null sdk object for a null sdk object", converter.toSDKChallenge(), is(nullValue()));
    }
    ...
    public void convertNullAPIToAPI() {
        apiChallenge = null;
        converter = new ChallengeConverter(apiChallenge);
        assertThat("Converter didn't return a null api object for a null api object", converter.toAPIChallenge(), is(nullValue()));
    }
    ...
    public void convertSDKToSDK() {
        ...
        assertThat("Converter returned a null sdk object for a non null sdk object", sdkChallenge, is(notNullValue()));
        assertThat("Converter didn't return the same non-null sdk object it was given", sdkChallenge, is(equalTo(sdkChallenge)));
    }
    ...
    public void convertAPIToAPI() {
        ...
        assertThat("Converter returned a null api object for a non null api object", apiChallenge, is(notNullValue()));
        assertThat("Converter didn't return the same non-null api object it was given", apiChallenge, is(equalTo(apiChallenge)));
    }
    ...
    public void convertAPIToSDK() {
        ...
        assertThat("Converter returned a null sdk object for a non null api object", sdkChallenge, is(notNullValue()));
    ...
    public void convertSDKToAPI() {
        ...
        assertThat("Converter returned a null api object for a non null sdk object", apiChallenge, is(notNullValue()));
