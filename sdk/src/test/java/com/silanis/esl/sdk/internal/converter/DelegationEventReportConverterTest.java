...
public class DelegationEventReportConverterTest implements ConverterTest {
    ...
    public void convertNullSDKToAPI() {
        ...
        assertThat("Converter didn't return a null api object for a null sdk object", converter.toAPIDelegationEventReport(), is(nullValue()));
    }
    ...
    public void convertNullAPIToSDK() {
        ...
        assertThat("Converter didn't return a null sdk object for a null api object", converter.toSDKDelegationEventReport(), is(nullValue()));
    }
    ...
    public void convertNullSDKToSDK() {
        sdkDelegationEventReport = null;
        converter = new DelegationEventReportConverter(sdkDelegationEventReport);
        assertThat("Converter didn't return a null sdk object for a null sdk object", converter.toSDKDelegationEventReport(), is(nullValue()));
    }
    ...
    public void convertNullAPIToAPI() {
        apiDelegationEventReport = null;
        converter = new DelegationEventReportConverter(apiDelegationEventReport);
        assertThat("Converter didn't return a null api object for a null api object", converter.toAPIDelegationEventReport(), is(nullValue()));
    }
    ...
    public void convertSDKToSDK() {
        ...
        assertThat("Converter returned a null sdk object for a non null sdk object", sdkDelegationEventReport, is(notNullValue()));
        assertThat("Converter didn't return the same non-null sdk object it was given", sdkDelegationEventReport, is(equalTo(sdkDelegationEventReport)));
    }
    ...
    public void convertAPIToAPI() {
        ...
        assertThat("Converter returned a null api object for a non null api object", apiDelegationEventReport, is(notNullValue()));
        assertThat("Converter didn't return the same non-null api object it was given", apiDelegationEventReport, is(equalTo(apiDelegationEventReport)));
    }
    ...
    public void convertAPIToSDK() {
        ...
        assertThat("Converter returned a null sdk object for a non null api object", sdkDelegationEventReport, is(notNullValue()));
    ...
    public void convertSDKToAPI() {
        ...
        assertThat("Converter returned a null sdk object for a non null api object", apiDelegationEventReport, is(notNullValue()));
