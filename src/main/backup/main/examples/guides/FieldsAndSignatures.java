...
import com.silanis.esl.sdk.builder.RadioButtonSetBuilder;
...
import static com.silanis.esl.sdk.builder.RadioButtonOptionBuilder.newOptionOnPage;
import static com.silanis.esl.sdk.builder.RadioButtonSetBuilder.newRadioButtonsForSigner;
...
public class FieldsAndSignatures {
    ...
    private static class RadioButtonSampleA {
        public static void main( String ... args ) {
            RadioButtonSetBuilder.newRadioButtonsForSigner( "john.smith@acme.com" );
        }
    }

    private static class RadioButtonSampleB {
        public static void main( String ... args ) {
            RadioButtonSetBuilder.newRadioButtonsForSigner( "john.smith@acme.com" )
                    .withOption( newOptionOnPage( 2 )
                            .atPosition( 100, 300 ) )
                    .withOption( newOptionOnPage( 2 )
                            .atPosition( 200, 300 ) )
                    .withOption( newOptionOnPage( 2 )
    ...
    private static class RadioButtonSampleC {
        // TODO: Not yet written!
    }

    private static class RadioButtonSampleD {
        // TODO: Not yet written!
    }
    ...
    private static class RequiredValueSampleB {
        public static void main( String ... args ) {
            RadioButtonSetBuilder.newRadioButtonsForSigner( "john.smith@acme.com" )
                    .withName( "dental coverage" )
                    .withOption( newOptionOnPage( 2 )
                            .atPosition( 100, 300 ) )
                    .withOption( newOptionOnPage( 2 )
                            .atPosition( 200, 300 ) )
            ...
            DocumentPackage documentPackage = newPackageNamed( "Sample Insurance policy" )
                    ...
                    .withDocument( newDocumentWithName( "First Document" )
                            ...
                            .withSignature( signatureFor( "john.smith@email.com" )
                                    ...
                                    .withStyle( SignatureStyle.HAND_DRAWN )
                                    .withSize( 200, 50 )
                                    .withRadioButtonSet( newRadioButtonsForSigner( "john.smith@email.com" )
                                            .withName( "dental coverage" )
                                            .withOption( newOptionOnPage( 1 )
                                                    .atPosition( 100, 300 )
                                                    .withSize( 50, 50 ) )
                                            .withOption( newOptionOnPage( 1 )
                                                    .atPosition( 200, 300 )
