    ...
    public static void main( String... args ) {
        ...
        DocumentPackage superDuperPackage = newPackageNamed( "Anchor Extraction Package" )
                ...
                .withDocument( newDocumentWithName( "First Document" )
                        .fromFile( "src/main/resources/2_formToFillAndSign.pdf" )
                        .enableExtraction()
                        .withSignature( SignatureBuilder.signatureFor( props.getProperty( "1.email" ) )
                                .withPositionAnchor( TextAnchorBuilder.newTextAnchor( "Frustration" )
                                ...
                                .withField( FieldBuilder.textField()
                                        .withPositionAnchor( TextAnchorBuilder.newTextAnchor("if applicable")
                                                .atPosition( TextAnchorPosition.TOPLEFT )
                                                .withSize( 150, 40 )
                                                .withOffset( 0, 0 )
                                                .withCharacter( 0 )
