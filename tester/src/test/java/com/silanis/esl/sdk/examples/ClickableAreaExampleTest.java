    ...
    public void verifyResult() {
        ...
        for (Signature signature : documentPackage.getDocument(DOCUMENT_NAME).getSignatures()) {
            for (Field field : signature.getFields()) {
                ...
                if (field.getId().toString().equals(ALIGNED_CHECKBOX_ID) && field.getClickableArea() != null) {
                ...
                if (field.getId().toString().equals(RADIO_ID) && field.getClickableArea() != null) {
                ...
                if (field.getId().toString().equals(ADDED_CHECKBOX_ID) && field.getClickableArea() != null) {
