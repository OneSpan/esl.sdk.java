...
public class DocumentExtractionExampleTest {
    ...
    public void verifyResult() {
        ...
        assertThat("The number of signatures in extracted document is wrong", actualSignatures.size(), is(6));

        Signature signature0 = signatureForTopLeft(actualSignatures, 224, 90);
        assertThat(signature0, notNullValue());
        ...
        assertSignature(signature0, HAND_DRAWN, 224, 90, 195, 28, 0);

        Signature signature1 = signatureForTopLeft(actualSignatures, 345, 93);
        assertThat(signature1, notNullValue());
        ...
        assertSignature(signature1, HAND_DRAWN, 345, 93, 195, 28, 0);
        ...
        assertSignature(signature2, INITIALS, 81, 89, 195, 28, 0);

        Signature signature3 = signatureForTopLeft(actualSignatures, 131, 541);
        assertThat(signature3, notNullValue());
        ...
        assertSignature(signature3, FULL_NAME, 131, 541, 195, 28, 0);

        Signature signature4 = signatureForTopLeft(actualSignatures, 726, 91);
        assertThat(signature4, notNullValue());
        ...
        assertSignature(signature4, HAND_DRAWN, 726, 91, 195, 28, 0);

        Signature signature5 = signatureForTopLeft(actualSignatures, 43, 54);
        assertThat(signature5, notNullValue());
        ...
        assertSignature(signature5, HAND_DRAWN, 43, 54, 195, 28, 1);
    }
