...
public class DocumentOperationsExampleTest {
    ...
    public void verifyResult() {
        ...
        assertThat("Document was not uploaded correctly.", documentPackage.getDocument(ORIGINAL_DOCUMENT_NAME), notNullValue());
        ...
        assertThat("Original document still exists.", documentPackage.getDocument(ORIGINAL_DOCUMENT_NAME), nullValue());
        assertThat("Document should have one signature.", documentPackage.getDocument(UPDATED_DOCUMENT_NAME).getSignatures().size(), greaterThan(0));
        ...
        assertThat("Original document still exists.", documentPackage.getDocument(ORIGINAL_DOCUMENT_NAME), nullValue());
        assertThat("Updated document was not deleted correctly.", documentPackage.getDocument(UPDATED_DOCUMENT_NAME), nullValue());
    }
}
