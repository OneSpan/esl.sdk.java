...
public class EventNotificationRegistrationExampleTest {
    ...
    public void verifyResult() {
        ...
        assertThat("EventNotificationConfig should have 20 events", config.getEvents().size(), is(20));
        ...
        assertThat("EventNotificationConfig should have 9 events", connectorsConfig.getEvents().size(), is(9));
