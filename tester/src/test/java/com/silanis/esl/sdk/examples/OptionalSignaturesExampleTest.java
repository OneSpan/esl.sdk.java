...
public class OptionalSignaturesExampleTest {
    ...
    public void verifyResult() {
        ...
        assertThat("signer1's signable signatures are not set correctly. ", example.signer1SignableSignatures.size(), hasSize(2));
        ...
        assertThat("signer2's signable signatures are not set correctly. ", example.signer2SignableSignatures.size(), hasSize(2));
