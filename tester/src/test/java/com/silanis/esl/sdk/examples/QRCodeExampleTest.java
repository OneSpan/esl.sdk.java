...
public class QRCodeExampleTest {
    ...
    public void verifyResult() {
        ...
        assertThat("First QR code's style was not set correctly.", example.addedQRCode1.getStyle().toString(), is(FieldStyle.BOUND_QRCODE.toString()));
        ...
        assertThat("Second QR code's style was not set correctly.", example.addedQRCode2.getStyle().toString(), is(FieldStyle.BOUND_QRCODE.toString()));
        ...
        for (Field field : modifiedQRCodeList) {
            if (field.getId().equals(example.qrCodeId1)) {
                assertThat("Modified QR code's style was not set correctly.", field.getStyle().toString(), is(FieldStyle.BOUND_QRCODE.toString()));
        ...
        for (Field updatedQRCode : updatedQRCodeList) {
            if (updatedQRCode.getId().equals(example.qrCodeId1)) {
                assertThat("First updated QR code's style was not set correctly.", updatedQRCode.getStyle().toString(), is(FieldStyle.BOUND_QRCODE.toString()));
            ...
            if (updatedQRCode.getId().equals(example.qrCodeId2)) {
                assertThat("Second updated QR code's style was not set correctly.", updatedQRCode.getStyle().toString(), is(FieldStyle.BOUND_QRCODE.toString()));
