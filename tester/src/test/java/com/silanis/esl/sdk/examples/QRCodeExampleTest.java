...
public class QRCodeExampleTest {
    ...
    public void verifyResult() {
        ...
        assertThat("Second QR code's y position was not set correctly.", example.addedQRCode2.getY(), is(both(greaterThan(99.0)).and(lessThan(101.0))));
        ...
        for (Field field : modifiedQRCodeList) {
            if (field.getId().equals(example.qrCodeId1)) {
                ...
                assertThat("Modified QR code's y position was not set correctly.", field.getY(), is(both(greaterThan(499.0)).and(lessThan(501.0))));
            }
        }
        ...
        for (Field updatedQRCode : updatedQRCodeList) {
            ...
            if (updatedQRCode.getId().equals(example.qrCodeId2)) {
                ...
                assertThat("Second updated QR code's y position was not set correctly.", updatedQRCode.getY(), is(both(greaterThan(599.0)).and(lessThan(601.0))));
            }
        }
