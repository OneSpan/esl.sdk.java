...
public class SignerInformationForEquifaxUSAExampleTest {
    ...
    public void verifyResult() {
        ...
        SignerInformationForEquifaxUSA signerInformationForEquifaxUSA = documentPackage.getSigner(example.email1).getKnowledgeBasedAuthentication().getSignerInformationForEquifaxUSA();
        ...
        assertThat( "date of birth in signerInformationForEquifaxUSA was not set correctly.",signerInformationForEquifaxUSA.getDateOfBirth().toString(), is( DATE_OF_BIRTH.toString()) );
